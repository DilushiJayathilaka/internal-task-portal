...
export function SignupForm() {
  ...
  return (
    <form
      action={formAction}
      // See login-form.tsx for why: disables the browser's native
      // validation popups without losing required/type="email"'s
      // accessibility value, so every submission reaches signupAction and
      // its errors render through the styled inline messages below.
      noValidate
    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className={`${baseInput} ${errors?.name ? invalidInput : validInput}`}
        />
        {errors?.name && (
